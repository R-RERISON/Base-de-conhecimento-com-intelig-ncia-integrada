...
- [ ] H023 Word Cloud — p580wc.2 semantic quality substantially improved in ENV; usage/count gap identified. `word-cloud-v1.2.0` / `0.5.0-p580wc.3` local PASS; environmental count/ranking recheck required.
