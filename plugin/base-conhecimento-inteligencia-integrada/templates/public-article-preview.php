...
<div class="bdc-public">
	...
	<?php Public_Experience::render_preview_banner( 'UX-005 / reader-clean v3 · ' . (string) $model['source_kind'] ); ?>
	...
	<main class="bdc-public-main bdc-reader">
		...
		<div class="bdc-reader-layout">
			...
			<?php if ( ! empty( $model['summary_items'] ) ) : ?>
				<aside class="bdc-reader-summary" aria-labelledby="bdc-reader-summary-title"><header><h2 id="bdc-reader-summary-title">Resumo Executivo</h2><small>Contexto rápido</small></header><div class="bdc-reader-summary__body"><dl>
