...
<div class="bdc-public">
	...
	<?php Public_Experience::render_preview_banner( 'UX-004 / search-first v3' ); ?>
	...
	<main class="bdc-public-main bdc-home">
		<section class="bdc-home-search-stage" aria-labelledby="bdc-home-title">
			...
			<form class="bdc-home-search" method="get" role="search">
				...
				<input id="bdc-home-query" data-bdc-primary-search type="search" name="bdc_global_q" value="<?php echo esc_attr( $query_value ); ?>" placeholder="Ex.: Windows, certificado, mensageria, acesso..." autocomplete="off">
				<kbd>Ctrl K</kbd>
